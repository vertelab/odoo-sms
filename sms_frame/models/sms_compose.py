...
class SmsCompose(models.Model):
    ...
    def send_entity(self):
        ...
        my_sms = self.from_mobile_id.account_id.send_message(self.from_mobile_id.mobile_number, self.to_number, self.sms_content.encode('utf-8') if self.sms_content else '', self.model, self.record_id, self.media_id)
